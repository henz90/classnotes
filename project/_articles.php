...
$app->map(['GET', 'POST'],'/class/{id:[0-9]+}', function ($request, $response, $args) {
    ...
    $commentsList = DB::query("SELECT co.commentid, u.username, co.date, co.body cl.classname, cl.classid FROM comments as co, users as u, classes as cl WHERE cl.classid = co.articleid AND co.userid = u.userid ORDER BY co.commentid");    
